...
def classifer_cnn(encoder_embed_input,keep_prob=0.5,reuse = False):
...
pred=classifer(l_encoder_embed_input,keep_prob =keep_prob)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(iter_num):
            ...
            while step < len(new_trainS) // batch_size:
                ...
                un_target_maxlength = len(sources_batch[0])   # get max length  +1
